...
Creates a GitHub Release and, in two-branch and three-branch mode, promotes the pre-production branch to `main`. Run this after preview/staging testing is confirmed.
...
### Step 1T — Verify on `main` with tag
...
Have you tested all of the above on the  environment? Type 'release' to confirm.
```
