...
<!-- No platform-specific compliance rules defined. Edit .codecannon.yaml to add them. -->
...
<!-- No project conventions defined. Edit .codecannon.yaml to add them. -->
...
<!-- generated by CodeCannon/sync.py | skill: review-agent | adapter: claude | hash: 60d6aa11 | DO NOT EDIT — run CodeCannon/sync.py to regenerate -->
