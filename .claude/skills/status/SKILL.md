...
argument-hint: "optional: lookback days (e.g. 14), a GitHub username (@alice), --milestone <name>, or --team"
---
...
<!-- generated by CodeCannon/sync.py | skill: status | adapter: claude | hash: 22a25479 | DO NOT EDIT — run CodeCannon/sync.py to regenerate -->
