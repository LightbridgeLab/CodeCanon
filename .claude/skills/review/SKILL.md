...
argument-hint: "PR number (optional — defaults to current branch's open PR)"
---
...
<!-- generated by CodeCannon/sync.py | skill: review | adapter: claude | hash: 59058ddb | DO NOT EDIT — run CodeCannon/sync.py to regenerate -->
